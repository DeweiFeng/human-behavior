...
SEGMENTS_DIR="/home/human-behavior/autism/data/ados_videos_and_frames/sample_1"
...
INFERENCE_SCRIPT="/home/human-behavior/autism/inference/_qwen_vl_inference.py"

# Output directory
OUTPUT_DIR="/home/human-behavior/autism/data/qwen_vl_outputs"
...
# If running non_test_prompt mode (manual)
NON_TEST_PROMPT_TXT="/home/human-behavior/autism/prompts/custom_prompt.txt"
    ...
    if [ -d "$SEGMENT_PATH" ]; then
        ...
        if [ "$RUN_NON_TEST_PROMPT" = true ]; then
            ...
            python "$INFERENCE_SCRIPT" \
                ...
                --output_path "$OUTPUT_DIR/${SEGMENT_NAME}_manual.json"
        else
